var drawCircle = function(selector){
    ...
    [].forEach.call(circles, function(el){
        ...
        var animationCircle = setInterval(function() {
          el.innerHTML = '<svg width="160" height="160"><circle transform="rotate(-90)" r="65" cx="-80" cy="80" /><circle transform="rotate(-90)" style="stroke-dasharray:'+ counterCircle +'px 408px;" r="65" cx="-80" cy="80" /></svg><span class="percents"></span>';
